...
const currentDate = new Date(2018, 5, 29);
const appointments = [
    {
...
const SchedulePage = () => {
    ...
    const getStartDayHourWeek = () => (
        Math.min(...appointments.map(a => a.startDate.getHours())) - 0.5
    );

    const getEndDayHourWeek = () => {
      const startDayHour = getStartDayHourWeek();
    ...
    const getEndDayHourDay = () => {
        const startDayHour = getStartDayHourDay();
        const daySchedule = appointments.filter(t => t.startDate.getDate() === currentDate.getDate());
    ...
    return (
        <Paper>
            ...
            >
                ...
                />
                {matches ?
                    <DayView startDayHour={getStartDayHourDay()} endDayHour={getEndDayHourDay()} />
                    :
                    <WeekView startDayHour={getStartDayHourWeek()} endDayHour={getEndDayHourWeek()}/>
                }
